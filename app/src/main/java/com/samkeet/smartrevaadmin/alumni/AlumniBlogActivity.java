...
public class AlumniBlogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alumni_blog);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent motionEvent) {
                ...
                if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AlumniBlogManager.class);
                    intent.putExtra("DATA", disscussionObject[temp].toString());
    ...
    public class GetDisscussion extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (authenticationError) {
                ...
                mAdapter = new AlumniBlogAdapter(disscussionObject, getApplicationContext());
