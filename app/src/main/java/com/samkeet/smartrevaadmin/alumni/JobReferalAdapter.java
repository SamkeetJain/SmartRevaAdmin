...
public class JobReferalAdapter extends RecyclerView.Adapter<JobReferalAdapter.ViewHolder> {
    ...
    public JobReferalAdapter(String[] mName, String[] mCompname,String[] mJobtype,String[] mJobrole) {
        this.mName = mName;
    ...
    @Override
    public JobReferalAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
